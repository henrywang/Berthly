...
# 2. rasterize masters
#    shadowed app-icon masters -> qlmanage (>=512, filters honored)
...
#    filter-free art -> NSImage (correct at any size)
...
mkdir -p "$IS"
cp berthly-master-1024.png "$IS/icon_512x512@2x.png"
sips -z 512 512 berthly-master-1024.png --out "$IS/icon_512x512.png"    >/dev/null
cp "$IS/icon_512x512.png" "$IS/icon_256x256@2x.png"
sips -z 256 256 berthly-master-1024.png --out "$IS/icon_256x256.png"    >/dev/null
cp "$IS/icon_256x256.png" "$IS/icon_128x128@2x.png"
sips -z 128 128 berthly-master-1024.png --out "$IS/icon_128x128.png"    >/dev/null
sips -z 64  64  berthly-small-512.png   --out "$IS/icon_32x32@2x.png"   >/dev/null
sips -z 32  32  berthly-small-512.png   --out "$IS/icon_32x32.png"      >/dev/null
cp "$IS/icon_32x32.png" "$IS/icon_16x16@2x.png"
sips -z 16  16  berthly-small-512.png   --out "$IS/icon_16x16.png"      >/dev/null
